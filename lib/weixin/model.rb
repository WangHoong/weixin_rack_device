...
module Weixin
  ...
  #     <Event><![CDATA[subscribe_status]]></Event>
  #     <DeviceID><![CDATA[gh_e4f055cce558_43069af7c2a9b11c9dd354d116f8c301]]></DeviceID>
  #     <DeviceType><![CDATA[gh_e4f055cce558]]></DeviceType>
  #     <OpType>2</OpType>
  #    <OpenID><![CDATA[oodPEs2Ry_2s3oZLBOM0tNrv4KyQ]]></OpenID>
  # </xml>
  DeviceMessage = Class.new(Message)
  ...
  class BindMessage
    ...
    xml_accessor :ToUserName, :cdata => true
    xml_accessor :FromUserName, :cdata => true
    xml_accessor :CreateTime, :as => Integer
    xml_accessor :MsgType, :cdata => true
    xml_accessor :Event, :cdata => true
    xml_accessor :DeviceType, :cdata => true
    xml_accessor :DeviceID, :cdata => true
    xml_accessor :SessionID, :as => Integer
    xml_accessor :Content,  :cdata => true
  ...
  class SubscribeMessage 
    ...
    xml_accessor :DeviceType, :cdata => true
    xml_accessor :DeviceID, :cdata => true
    xml_accessor :DeviceStatus,  :as => Integer
